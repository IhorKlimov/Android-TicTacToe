...
import br.com.gorio.jogodavelha.model.Point;
import br.com.gorio.jogodavelha.model.Shape;
import br.com.gorio.jogodavelha.model.Victory;
import br.com.gorio.jogodavelha.model.VictoryLine;

import static android.graphics.Paint.Style.STROKE;
import static br.com.gorio.jogodavelha.Constants.CIRCLE;
import static br.com.gorio.jogodavelha.Constants.DRAFT;
import static br.com.gorio.jogodavelha.Constants.ENEMY;
import static br.com.gorio.jogodavelha.Constants.ME;
import static br.com.gorio.jogodavelha.Constants.NONE;
...
//        background = findViewById(R.id.background);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        line.setColor(Color.parseColor("#688391"));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        Log.e(TAG, "onTouchEvent: " + isMyTurn);
    ...
    private void startAnimation(int row, int col, boolean isCircle) {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                Log.e(TAG, "onAnimationEnd: " + isMyTurn);
...
//                    background.setBackground(new BitmapDrawable(getResources(), back));
    ...
    private void restart() {
        ...
        Log.e(TAG, "restart: " + isMyTurn);

        if (!isWIfi) {
            isMyTurn = true;
        } else {
            if (MY_SHAPE == Constants.X) {
                isMyTurn = games % 2 != 0;
            } else {
                isMyTurn = games % 2 == 0;
            }
...
//        background.setBackground(null);
    ...
    public void checkTurn() {
        if (isMyTurn) {
            turn.setTextColor(Color.parseColor("#9E9E9E"));
        ...
        turn.animate().scaleY(1f).scaleX(1f).setListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                super.onAnimationEnd(animation);
            }
    ...
    public void updateScore(){
        score.setText(String.format(Locale.getDefault(),"GAME: %d | WIN: %d | LOOSE: %d", games, winner, loose));
    }
    ...
    public void setMe(String me) {
        ...
        Log.e(TAG, "setMe: " + isMyTurn);
    }

    public void loadAd() {
        mInterstitialAd = new InterstitialAd(getContext());
        mInterstitialAd.setAdUnitId("ca-app-pub-1434555711423110/4768398060");
        mInterstitialAd.loadAd(new AdRequest.Builder().build());
    }
}